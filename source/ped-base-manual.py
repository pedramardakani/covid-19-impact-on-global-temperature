...
plotname = "manual-scale-base-index-"+str(check_index)+"-"
#plottype = "png"
plottype = "pdf"
...
res.cnMinLevelValF	= -60.0 #-- minimum contour value
res.cnMaxLevelValF	= +60.0 #-- maximum contour value
...
#-- Set the plot name
plotname = f.variables['skt'].attributes['long_name'] + ' -PS- '
